...
import UsefulLinkItem from './UsefulLinkItem.jsx'
...
class UsefulLink extends React.Component {
  constructor(props) {
    ...
    var linkedin = {
        name: 'LinkedIn',
        description: 'Most important to have LinkedIn Profile\nCan connect with hiring managers and recruiters.',
        url: 'https://www.linkedin.com',
        iconurl: 'https://content.linkedin.com/content/dam/me/brand/en-us/brand-home/logos/01-dsk-e8-v2.png/jcr:content/renditions/01-dsk-e8-v2-2x.png'
    }

    var keyvalues = {
        name: '{ key : values }',
        description: 'Engineering teams describe their culture and how their values translate into daily practices.\nFind Open position by company\'s culture and values.',
        url: 'https://www.keyvalues.com',
        iconurl: 'https://www.keyvalues.com/images/global/header-logo.jpg'
    }

    var angellist = {
        name: 'AngelList',
        description: 'AngelList is where the world meets startups.\nFind a great startup job, invest in a startup, or raise money.',
        url: 'https://angel.co',
        iconurl: 'https://angel.co/webpack/64bfdcefe79bd40c1c90e9096fd76255.svg'
    }

    var glassdoor = {
        name: 'GlassDoor',
        description: 'Search millions of jobs.\nSearch companies with employee reviews, personalized salary tools, and more.',
        url: 'https://www.glassdoor.com',
        iconurl: 'https://s3-eu-west-1.amazonaws.com/tpd/logos/4bdbb18000006400050561cf/0x0.png'
    }

    var indeed = {
        name: 'indeed',
        description: 'You can search millions of jobs online to find the next step in your career.\nWith tools for job search, resumes, company reviews and more.',
    ...
    var whoishiring = {
        name: 'Whoishiring.io',
        description: 'The map with the collection of jobs for Software Engineers, Software developers, Programmers, Designers and remote.\nAggregator of job post from Hacker News.',
        url: 'https://whoishiring.io',
        iconurl: 'https://res-5.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco/v1477499999/knrg0thncgorcntdao6j.jpg'
    }

    var hired = {
        name: 'HIRED',
        description: 'With Hired your job search has never been easier!\nSimply create a profile & vetted companies compete for you, reaching out with salary.',
        url: 'https://www.hired.com',
        iconurl: 'https://www.techdayhq.com//system/companies/logos/000/003/357/original/hired-logo-transparent-padding_%283%29_%284%29.png?1522337643'
    }

    var jobBoards = [];
    jobBoards.push(linkedin, keyvalues, angellist, glassdoor, indeed, whoishiring, hired);
  ...
  render() {
    return (
      <div>
        <span className="job_board_title">🔖 Job Boards</span>
        {
            this.state.jobBoards.map((b) => {
                return <UsefulLinkItem key={b.name} linkInfo={b} /> 
            })
        }
      </div>
    )
